...
main_bottomsize: 0.1
title: '**Spatial Point Processes modelling with INLA/SPDE: are finer covariate resolutions always better?**'
author:
...
main_findings:
  - "**Inadequate model covariate resolution relative to that of the mesh can lead to highly unreliable numerical integration**."
