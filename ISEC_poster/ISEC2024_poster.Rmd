...
<font size="7"> **Figure 1**: In environmental variables with very short
range like the one pictured below, the values change from 100 to 0 in
very short distances. If the resolution of the integration points is not
small enough to capture this short range, the model will struggle to
...
<!--# I've just tried using the Markdown/Latex sysntax instead of using R chunks. You can inseret a figure by sekect Insert - Figure from the top bar of the RMarkdown aditor -->
...
<font size="7"> **Figure 2**: Three covariates randomly generated.
...
![](Figure_3.png){width="963"}

<font size="7"> **Figure 3**: This six meshes have been created with
...
![](Figure_4.png){width="963"}

<font size="7"> **Figure 4**: This six meshes have been created with
exaclty the same parameter, except that the iner boundary is shifted in
space a little bit for each of them. That makes the integration points
that are the vertices of the triangles shift a little too. </font>
